...
- **Conversion-tracking diagnosis and switch, 23 Sep 2026.** The owner's Ads screenshots (1&ndash;22 Sep) showed the only Primary purchase action was the **GA4 import** (`www.thefirealarmsupplier.com (web) purchase`, id 6910639875, 90-day click window): **825 conversions / $314,748**, while the **Shopify app tag** `Google Shopping App Purchase (1)` (id 7700459405, 30-day, data-driven, enhanced conversions already enabled) sat as **Secondary** with **917 / $327,649**, against **1,733 Shopify orders / $738,757** in the same period. Both tags' &quot;Needs attention&quot; was only *&quot;COGS not available&quot;* &mdash; a profit-reporting note, not a firing problem; both had conversions on 22 Sep. So nothing was broken: the bidder was steering on the GA4 import, which only receives the share of cross-channel credit GA4 assigns to Ads. **Owner switched Primary to the app tag and GA4 to Secondary the same day.** Expect the reported ROAS to rise without any change in sales; judge the combined tROAS + tag change on budget utilisation and MER around **6 Oct**, not on reported ROAS. The same app tag was the one Primary alongside GA4 in Jul&ndash;Aug that double counted &mdash; the rule is one Primary purchase action, ever.
- **Spend vs stock since Jan 2025 (Windsor item-level, 23 Sep).** $1.08M spend / $10.3M value (ROAS 9.5). Stock-0 items: $266k spend, $2.34M value, ROAS 8.8, 1,400 of them selling $23M in the ERP &mdash; unpublishing stock-0 items would cost far more than it saves. Waste = 1,653 stock-0 items with no conversion and no ERP sale: $13.8k over 21 months (Resideo 750 of them). 60% of the active catalogue was never advertised, 87% of those created Jun&ndash;Sep 2026 and 87% of those without a real photo; of the 1,299 older never-advertised, 491 sell in the ERP ($2.26M) &rarr; 438 (excluding 53 already in the 264 campaign) labelled `custom_label_0 = erp_sells_never_advertised` on 23 Sep with the owner's approval.
