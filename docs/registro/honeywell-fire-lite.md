...
### e07 (23 Sep 2026): BG12TR

- DF-52004:A1 (04/22/08) orders the BG12TR as the "Optional trim ring for semi-flush mounting"; DF-52013:D (4/13/2012, BG-12LX) says it is usually needed on 4 in. square or double-gang boxes, not single-gang. **The live "Lexan" was unsourced** (LEXAN describes the pull station, not the ring) and was removed from the title. The BG-12S/BG-12SL installation sheets (I56-2263-005, I56-2269-004) call the ring "BG-TR". Routes: `DF_52004.pdf` (underscore) resolves; for DF-52013 only lowercase `df-52013.pdf` resolves. The buildings.honeywell.com firelie path gave the 608 B 404 for both. Installation sheets: `installation-guides/I56-2263-005.pdf?download=false`.

### e09 (23 Sep 2026): RZA-5F and SEISKIT-BB17

- **RZA-5F:** DF-52248 B-600 (07/13/04; text layer unreadable, render it; only lowercase `df-52248.pdf` resolves) and drawing 15635 Rev B (7/31/97): **requires ADM-12 (12 VDC MS-5012) or ADM-24 (24 VDC MS-5024/MS-5024UD)**. The live "Use W/Adm-12 Driver" was wrong for the 24 V panels. Neither driver nor any of the three panels is stocked, so the condition went into the title. On the RZA page the "Discontinued" badge sits inside a `d-none` div (page chrome).
- **SEISKIT-BB17:** announcement FLPA14-02-01 (02/06/14): "Seismic kit for the BB-17F. Includes battery bracket for two 18AH batteries". Installation document 53853:B (12/16/2022, EDAM `hbt-fire-53853-B-installation-manual.pdf`): one bracket, two #6-32 screws, two keps nuts, **Power-Sonic PS-12180 only**, Hilti KH-EZ anchors. The Fire-Lite seismic route `buildings.honeywell.com/content/dam/hbtbt/en/documents/document-lists/firelie/seismic/` (honest 587 B 404) serves the **older Rev A (2010), with Kwik Bolt 3 anchors**: two revisions on two hosts. Certificate VMA-45894-03C expired 11/30/2016 but is still linked.
