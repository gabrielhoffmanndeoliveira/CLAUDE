...
### t14 (23 Sep 2026): P2GWLED, and a cheap single-product lot

- **P2GWLED:** data sheet AVDS916-01 (10/03/2023, EDAM `L-Series-LED-Indoor-Horns-Strobes-and-Horn-Strobes-Data-Sheet.pdf`) p4 ordering row: "2-Wire, Compact Horn Strobe, Wall, White". Only the -P models are plain; the rest carry FIRE. Wall units select 15–185 cd; that list covers all wall units, with no compact-specific list. **Replacement sourced:** bulletin M23.2SS (Oct 2023) p2 REPLACES table lists P2GWLED as replacing P2GWL. Published title: "System Sensor P2GWLED L-Series LED Compact Horn Strobe, 2-Wire, Wall, White, FIRE, 15-185 cd (Replaces P2GWL)". $12k ERP, 28 in stock.
- **Cost measurement:** an agent briefed inline, told not to read CLAUDE.md or the registro, with the route given, used **76k tokens, 10 tool calls and 66 s**, against 145–175k for a 6-product lot. For one high-value product this format is the cheap way.
- Live nameless-title count among in-stock active products (bulk pull, 23 Sep): 6 of 3,741. The other 5 (Gamewell 1100-0439, Notifier DR-APF100, System Sensor 5351H, TCS Basys TS1002, Eaton LSTW3) have no revenue and were left alone under the stop decision.
