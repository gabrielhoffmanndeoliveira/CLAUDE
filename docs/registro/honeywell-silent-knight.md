...
### e07 (23 Sep 2026): ECS-INT50W is Farenhyt, not Silent Knight

- Data sheet 350980 Rev C (04-22) and installation document LS10119-001SK-E:D (2/22/2022) name Farenhyt 3 and 4 times; Silent Knight appears 0 times. **`ECS-` numbers are Farenhyt; `EVS-` numbers are Silent Knight.** The Silent Knight twin is EVS-INT50W (350981 C, 6820EVS), stocked at $825.30. The twin sheets differ on shipping weight (4 vs 2 lb), so none was published. The board fits inside IFP-300ECS and IFP-2000ECS cabinets; IFP-2100ECS, or a cabinet holding an ECS-NVCM, needs the ECS-AMPMT kit. **The store has no Farenhyt vendor**; vendor Silent Knight → Farenhyt was flagged. Following the N-FPJ precedent the title keeps the vendor word first and says "for Farenhyt IFP ECS Panels"; the body opens "Honeywell Farenhyt". Check the other `ECS-`/`IFP-` parts for vendor.
- Routes: EDAM `hbt-fire-350980-C.pdf` resolves bare; `hbt-fire-350981-C.pdf?download=false` resolves with the suffix.
