...
- **MB motor bells are DC only, and Eaton's own SKU page says AC (audit t02).** TD450055EN (Apr 2019) Table 1 (coordinator-verified): `MB-G6-24-S 4222 6" 24 0.030 0.040`, page 1 &quot;DC vibrating&quot;, 12 and 24 VDC models only; P81960P lists no AC model. The SKU-page headline and its generated spec PDF for MB-G6-24-R print &quot;24 VAC&quot; &mdash; second Eaton SKU-page headline error after HSR's dB printed as cd. No colour column in the ordering table; colour lives only in SKU-page attributes. urllib failed ~5 times then a fresh process with a 90 s timeout pulled all five files.
