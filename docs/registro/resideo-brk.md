...
- **[Decay] `brkelectronics.com` product pages answer again (v2b52):** 200 `text/html`, 358,668 B, with the `digitalassets.resideo.com` PDF links in the markup (swap backslashes). `TechLitDocuments/BRK-First%20Alert/<MODEL>_SpecSheet.pdf` resolves by sibling slug; bogus = 766 B HTML 404; digitalassets miss = 148 B. SM500V spec sheet: *&quot;Certified to UL217&quot;* (the SMCO500V twin adds UL2034) &mdash; so &quot;Alarm&quot;, not &quot;Detector&quot;. Manual `M08-0604-000` (Spanish `-001`): wireless interconnect only with SMCO500V/SM500V, up to 18 units, at most 12 smoke; must not be wired. The live title's bare &quot;Interconnect&quot; read as hardwired.
