...
- **(enrichment e01)** `xtralis.com/file/<id>` now 301s to the bare host (`curl -L`); bogus id &rarr; `/sitemap_404` 233,961 B. VLI Product Guide/data sheet/A&amp;E (7238, 7359, 7236) return a **sign-in page at 226,239&ndash;226,241 B &mdash; the recorded &quot;miss&quot; fingerprint also covers login-gated documents.** VSP-036 = VLI Ultrasonic Flow Manifold Spare (file/707, Doc 17115_21 p2, coordinator-verified). Honeywell's &quot;This product has been discontinued&quot; on VSP-036 is product-specific (0 on a control page) &mdash; lifecycle flagged.
