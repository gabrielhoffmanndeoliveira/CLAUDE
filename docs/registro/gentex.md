...
- **`GEC3-12WR` settled from the 12 V columns only (v2b52).** `551-0050-07` ordering row, coordinator-verified: `GEC3-12WR | 904-1231-002 | 12 | 15, 30, 60, 75` &mdash; catalogue number correct, character by character (the `GB10-120` 901-/904- swap did not recur). 110 cd is 24 V only; CSFM 7135-0569:130 is the per-class listing for GEC3-12/GEH-12; ULC is 24 V only. **No 12 V strobe current published** because of the recorded 106 mA vs 92 mA-maximum defect in the 15 cd cell. The live title had no candela, voltage or finish; it now carries all three.
