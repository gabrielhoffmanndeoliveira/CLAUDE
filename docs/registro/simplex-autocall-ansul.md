...
- t07 (23 Sep): **4904-9176** is in S4904-0008-6 (11/2014) p2 (render): 15 cd, red with white FIRE lettering, **vertical** wall mount. 4904-9178 is the same strobe for horizontal mounting; mounting is the only differentiator. "TrueAlert Non-Addressable" is in the JCI index `prodname` field only and appears zero times in the sheet: another case of a metadata hit that is not a text hit.
- t10 (23 Sep): **4098-9784**: 4090-0011 Rev. 26 (06/2023) Table 8 lists "Standard Sensor Base 4 in." for IDNet and MAPNET II. **The document separates the current chart (Table 1) from legacy-inclusive tables (Table 8 on).** 4098-9784 appears only in the latter, and Table 1's standard base is 4098-9792/-9776. That is a lifecycle signal (flagged), not a title word. The store title had import garbage ("discountinued)true").
