...
- t12 (23 Sep): **ALCN-960MISO** (CAT-9524 Rev 0): a quad loop adder module motherboard, 2 SLCs, expandable to 4 with ALCN-960D; the sheet says "FleX-Net panel" only. **SP-404-70AW** (CAT-5710 Rev 6): in-suite silenceable, **requires the SSW-100 remote switch**; the baffle is "off white" and (W) is undecoded, so no colour in the title. CAT-5710 p4 prints a 25 V "speaker voltage" on the 70 V rows (a sheet error). `wp/v2/product?search=SP-404` returned 0, a false negative. The truncated raw-quote titles also sit on SP-404SW-70AW, SP-504-70AW and SP-504SW-70AW (no demand).
