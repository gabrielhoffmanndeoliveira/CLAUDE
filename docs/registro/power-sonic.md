...
- **Yuasa order-number grammar is per model (audit t03):** NP1.2-12 bare = standard case, `NP1.2-12FR` FR; NP12-12 `-250`/`-250FR`; **NP24-12 has six** (B, BFR, -250, -250FR, R, RFR &mdash; three terminals &times; two cases), so the bare SKU fixes neither terminal nor case; NP38-12 `B`/`BFR`. NP38-12's current sheet MKT-086 gives 40.6 Ah at 20 hr and 38.9 at 10 hr while its own product photo shows a 38.0Ah label &mdash; ratings changed between generations (NP12-12: 12.0 label vs 12.2 table). **The coordinator removed capacity from the NP38-12 title** until a carton is read. `gsyuasa-es.com` WP REST exposes `products`/`specsheet`; `wp/v2/search` is honest.
