...
- t11 (23 Sep): **U5015 = ClearView 3D explosion-proof photoelectric smoke detector.** The model matrix is in manual 95-8723 Rev 3.8 p.12 (the 2026 spec sheet has none): A aluminium / 4 ports / N 3/4" NPT (M = M25) / 12 = 0-20 mA + relay non-latching, 13 = latching / A FM-IECEx-CSA. Found through the WP media API `search=U5015` (bogus 0, X3301 28). FM 3230; UL 268A covers only the Q5017R duct mount. **Stock numbers 012500-3xx repeat 012500-2xx one for one under the same model codes, and no Det-Tronics document carries any 012500 number**: a generation or a duplicate listing (flagged).
