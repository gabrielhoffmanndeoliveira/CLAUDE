...
- t11 (23 Sep): notifier.it `catalogo.asp?id=N&ln=eng` pages are honest (bogus id 75 B). **BRS-PC-I02** = NFXI-BSF-WCS: standard-performance detector base sounder strobe, C-3-8.5, red flash behind a clear lens. The B501AP base is purchased separately (D1148 Issue 1; BRE certificate 166r-(cl-3) Issue 04). BRH = premium (WCH). The WSO grammar holds for BSO but **not for BRS** ("PC" is decoded by no document; BRE uses WC). **BSO-PP-I02**: BRE 2831-CPR-F1953 Issue 01 (2019). The CPR number differs from the 2016 Notifier Italia sheet (0832-CPR-1814). The siblings BSO-BB-I02, BSO-DD-I02 and BRH-PC-I02 still carry the field-list titles (no demand; not queued under the stop decision).
